      ...
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          ...
          <div className="hidden lg:block">
            <h1 className="text-md font-normal text-gray-900 dark:text-white uppercase">
              <a href="/" className="text-blue-600">E-COMMERCE (TEST)</a> / {pageTitle}
            </h1>
          </div>
        </div>
              ...
              <div className="relative user-dropdown">
                ...
                >
                  ...
                  <div className="hidden sm:block text-left">
                    <p className="font-semibold uppercase text-gray-900 dark:text-white">{user.name}</p>
                  </div>
                ...
                {isDropdownOpen && (
                  <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-2 z-50">
                    ...
                    <button
                      ...
                      className="w-full flex uppercase items-center gap-3 px-4 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20"
                    >
